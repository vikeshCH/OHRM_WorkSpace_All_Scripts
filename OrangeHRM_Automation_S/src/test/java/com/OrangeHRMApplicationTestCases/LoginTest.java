...
public class LoginTest extends BaseTest {
	...
	public void LogInPageValidationTest() throws IOException {
		...
		System.out.println(" The expected Title of the OrangeHRM Applicatin LogIn Page is :- "
				+ expected_OrangeHRMApplicatinLogInPageTitle);

		// OPeration on the WebPage
		String actual_OrangeHRMApplicatinLogInPageTitle = driver.getTitle();
		System.out.println(" The Actual Title of the OrangeHRM Applicatin LogIn Page is :- "
				+ actual_OrangeHRMApplicatinLogInPageTitle);
		...
		// Expected - OrangeHRM Application Url address should have a text
		// orangehrm-4.2.0.1
		String expected_OrangeHRMApplicationUrlAddress = "orangehrm-4.2.0.1";
		System.out.println(" The Expected Url address of OrangeHRM Application LogIn Page is :- "
				+ expected_OrangeHRMApplicationUrlAddress);

		String actual_OrangeHRMApplicationUrlAddress = driver.getCurrentUrl();
		System.out.println(" The Actual Url address of OrangeHRM Application LogIn Page is :- "
				+ actual_OrangeHRMApplicationUrlAddress);

		if (actual_OrangeHRMApplicationUrlAddress.contains(expected_OrangeHRMApplicationUrlAddress)) {
			System.out.println(
					" Successfully Navigated to OrangeHRM Application LogIn Page - Url address Matched - PASS ");
		} else {
			System.out.println(
					" Successfully Navigated to OrangeHRM Application LogIn Page - Url address NOT Matched - FAIL ");
		}
		...
		System.out.println(" The Actual Text of the OrangeHRM Application LogIn Page is :- "
				+ actual_OrangeHRMApplicationLogInPage_logInPanelText);
	...
	public void LogInTest() throws IOException {
		...
		// String userNameTestData="srini"; // Test data - which should be passed to
		// sendKeys method
		By userNameProperty = By.id(properties.getProperty("orangeHRMApplicationUserProperty")); // idetifying the
																									// property of an
																									// element assigned
																									// to a variable
		// the property of the element should be identified in the WebPage
		WebElement userName = driver.findElement(userNameProperty); // WebElement is an interface of Selenium ( which
																	// can be treated as a dataType )
		...
		By passwordProperty = By.name(properties.getProperty("orangeHRMApplicationPasswordProperty")); // identify the
																										// Property
	...
	public void OrangeHRMApplication_HomePageValidationTest() throws IOException {
		...
		if (actual_OrangeHRMApplicationHomePageText.contains(expected_OrangeHRMApplicationHomePageText)) {
			...
			// Row newRow=logInTestDataSheet.createRow(1); // this will create that row as a
			// fresh - the data already existing will be deleted
			// Cell newRowOfNewResultCell=newRow.createCell(2);

			// Of the same Existing Row of the Test Data - a new Cell is created to save the
			// Result
